...
from scripts.step5_filtering_positions_and_snp_editing_DB_intersections import filter_by_cb_count
...
def get_df(input_dir):
    ...
    # get filtered df
    df_agg_intrsct_filtered = filter_by_cb_count(df_agg=df_agg_intrsct,
...
#     parser.add_argument('input_dir', help='path to folder with outputs from step4_aggregation_per_position.py')
#
